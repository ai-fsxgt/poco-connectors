...
parent: { data_source_id: "tasks-db-uuid" }
...
content_updates: [{
old_str: "[Exact acceptance criteria section returned by notion-fetch]",
new_str: "[The same complete acceptance criteria section, unchanged]
