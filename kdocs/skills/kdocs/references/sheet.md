...
| [`sheet.update_sheet`](sheet/worksheet.md) | 重命名工作表 | `file_id`, `worksheet_id`, `name` |
| [`sheet.delete_sheets`](sheet/worksheet.md) | 删除工作表 | `file_id`, `worksheet_ids` |
...
| [`sheet.add_row`](sheet/data.md) | 追加一行数据 | `file_id`, `worksheet_id`, `range_data` |
...
| HTTP 状态非 200 | 请求本身失败，检查 POCO 连接器授权状态 |
